...
public class Cell {
    ...
    private Cell(
        int nearbyLandMinCount,
        boolean isLandMine, boolean isFlagged, boolean isOpened
    ) {
    ...
    public void updateNearbyLandMindCount(int nearbyLandMinCount) {
        this.nearbyLandMinCount = nearbyLandMinCount;
    }
    ...
    public boolean hasLandMineCount() {
        return this.nearbyLandMinCount != 0;
    }
